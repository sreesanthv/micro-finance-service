...
func (_m *AccountRepo) Create(_a0 context.Context, _a1 *domain.Account) (int, error) {
...
func (_m *AccountRepo) Delete(_a0 context.Context, _a1 int) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *AccountRepo) Get(_a0 context.Context, _a1 int) (*domain.Account, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AccountRepo) GetByEmail(_a0 context.Context, _a1 string) (*domain.Account, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AccountRepo) SaveTransaction(_a0 context.Context, _a1 *domain.Transaction) (int, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *AccountRepo) Update(_a0 context.Context, _a1 *domain.Account) error {
	ret := _m.Called(_a0, _a1)
